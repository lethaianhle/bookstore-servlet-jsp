...
public class OrderDetail implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "oderId", column = @Column(name = "oder_id", nullable = false)),
	...
	@JoinColumn(name = "oder_id", insertable = false, updatable = false, nullable = false)
